using Dietcode.Classic.DomainValidator.ObjectValue;
using System.Net;

namespace Dietcode.Classic.DomainValidator
{
    /// <summary>
    ...
    public abstract class ValidationResultBase
    {
        ...
        /// </summary>
        public List<Entries> Entries { get; set; } = new();
        ...
        /// Mensagem principal associada ao resultado.
        /// </summary>
        public List<MensagemData> Mensagens { get; } = new();
