...
public partial class QRCodeGenerator
{
    ...
    private static class CapacityTables
    {
        ...
        /// <exception cref="Dietcode.Core.Lib.Codes.Exceptions.DataTooLongException">
        ...
        public static int CalculateMinimumMicroVersion(int length, EncodingMode encMode, ECCLevel eccLevel)
        {
            ...
            throw new Dietcode.Core.Lib.Codes.Exceptions.DataTooLongException(eccLevel.ToString(), encMode.ToString(), maxSizeByte);
        }
