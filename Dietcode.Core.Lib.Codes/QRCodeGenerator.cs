...
public partial class QRCodeGenerator : IDisposable
{
    ...
    /// <exception cref="Dietcode.Core.Lib.Codes.Exceptions.DataTooLongException">Thrown when the payload is too big to be encoded in a QR code.</exception>
    ...
    public static QRCodeData GenerateMicroQrCode(string plainText, ECCLevel eccLevel = ECCLevel.Default, int requestedVersion = 0)
    {
        ...
        else
        {
            ...
            if (minVersion < version)
            {
                ...
                throw new Dietcode.Core.Lib.Codes.Exceptions.DataTooLongException(eccLevel.ToString(), encoding.ToString(), version, maxSizeByte);
            }
        }
