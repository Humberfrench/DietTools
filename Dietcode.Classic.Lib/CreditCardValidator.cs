    ...
    public static class CreditCardValidator
    {
        ...
        public static string ValidaBandeira(string card)
        {
            try
            {
                ...
                int first = int.Parse(card.Substring(0, 1));
                int second = int.Parse(card.Substring(0, 2));
                int third = int.Parse(card.Substring(0, 3));
                int forth = int.Parse(card.Substring(0, 4));
                int bin6 = int.Parse(card.Substring(0, 6));
